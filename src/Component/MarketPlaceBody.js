    ...
    <div className="bg-[#f9f9f9] overflow-x-hidden w-full font-sans">
      ...
      <div className="flex flex-col md:flex-row items-center justify-center flex-wrap gap-[20px] p-[40px] px-[20px] bg-white text-center md:text-left w-full">
        <div className="flex-1 w-full md:max-w-[50%] p-[50px]">
          ...
          <p className="text-[0.9rem] lg:text-[1.1rem] leading-[1.6] text-[#555] mb-[20px]">
            The GoViMart is a versatile online platform offering both wholesale
            and retail options for fresh vegetables, fruits, mushrooms, grains,
            and more. Customers can choose from pre-packaged bundles or select
            custom items to suit their needs. Whether buying for personal use or
            business, the platform offers flexible pickup or scheduled delivery
            options, allowing repeat orders over a set duration for added
            convenience. It’s the perfect place to access quality produce,
            tailored to any scale of demand.
          </p>
          <button
      ...
      <div className="flex flex-col md:flex-row items-center justify-center gap-[30px] p-[40px] px-[20px] text-center md:text-left w-full">
        ...
        <div className="flex-[2] w-full">
          <h2 className="text-[1.8rem] mb-[20px] text-[#333]">
            Benefits to Buyers
          </h2>
          <div className="flex flex-col gap-[20px]">
            {/* Card 1 */}
            <div className="flex flex-col md:flex-row items-center bg-white border border-[#ddd] border-b-[6px] border-r-[6px] border-b-[#00957D] border-r-[#00957D] rounded-[25px] p-[25px] shadow-sm text-center md:text-left">
              <img
                src={icon1}
                alt="Wholesale Options"
              ...
              <div>
                ...
                <p className="text-[0.9rem] text-[#555] leading-[1.5]">
                  The platform offers both wholesale and retail choices for
                  fresh produce, including vegetables, fruits, mushrooms, and
                  grains.
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col md:flex-row items-center bg-white border border-[#ddd] border-b-[6px] border-r-[6px] border-b-[#00957D] border-r-[#00957D] rounded-[25px] p-[25px] shadow-sm text-center md:text-left">
              ...
              <div>
                <h3 className="text-[1.2rem] mb-[5px] text-[#333]">
                  Pre-packaged bundles or custom selections
                </h3>
                <p className="text-[0.9rem] text-[#555] leading-[1.5]">
                  Customers can choose from convenient pre-packaged bundles or
                  customize their order to meet specific needs.
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col md:flex-row items-center bg-white border border-[#ddd] border-b-[6px] border-r-[6px] border-b-[#00957D] border-r-[#00957D] rounded-[25px] p-[25px] shadow-sm text-center md:text-left">
              ...
              <div>
                <h3 className="text-[1.2rem] mb-[5px] text-[#333]">
                  Flexible pickup or scheduled delivery
                </h3>
                <p className="text-[0.9rem] text-[#555] leading-[1.5]">
                  Options for flexible pickup or scheduled delivery ensure
                  convenience for both personal and business customers.
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col md:flex-row items-center bg-white border border-[#ddd] border-b-[6px] border-r-[6px] border-b-[#00957D] border-r-[#00957D] rounded-[25px] p-[25px] shadow-sm text-center md:text-left">
              ...
              <div>
                <h3 className="text-[1.2rem] mb-[5px] text-[#333]">
                  Repeat orders for added convenience
                </h3>
                <p className="text-[0.9rem] text-[#555] leading-[1.5]">
                  Customers can set up repeat orders, ensuring a consistent
                  supply of fresh produce over a set duration.
                </p>
              </div>
            </div>
          </div>
